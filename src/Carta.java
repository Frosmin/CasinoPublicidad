...
public class Carta extends Figura implements Serializable{
    ...
    public Carta(int x, int y) {
        this.x = x;
        this.y = y;
        this.color1 = Color.WHITE; // Color de la carta (blanco)
        this.colorFondo = Color.BLACK; // Color de fondo de la parte trasera de la carta (negro)
    }
